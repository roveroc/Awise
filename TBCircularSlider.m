...
//** Draw the circle (using a clipped gradient) **/
    ...
    CGContextAddArc(imageCtx, self.frame.size.width/2  , self.frame.size.height/2, radius, 0, ToRad(self.angle), 1);
    ...
    CGFloat components[8] = {
        0.0, 1.0, 0.2, 1.0,     // Start color - Blue
        0.1, 1.0, 0.0, 1.0 };   // End color - Violet
